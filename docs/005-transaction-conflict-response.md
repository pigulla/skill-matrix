...
- Recorded as a live, explicitly undecided follow-up — see [architecture-review.md](architecture-review.md) finding 2 and the "Out of scope" section of the plan that implemented this ADR. Not chosen here because it needs its own analysis, not because it was rejected on the merits.
